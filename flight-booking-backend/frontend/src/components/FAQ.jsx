...
const faqData = [
  {
    ...
    answer:
      "Skyscanner is a travel search engine that compares prices from hundreds of airlines and travel agents to find you the best deal on flights, hotels and car hire.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Skyscanner is a search engine, so when you've found your flight, we'll transfer you directly to the airline or travel agent.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes! Skyscanner compares millions of hotels worldwide.",
  },
  {
